...
| jacobhm98/[**yati**](https://github.com/jacobhm98/yati) | Git worktree manager with tmux and docker-compose integration | 6 |
...
| Morantron/[**tmux-fingers**](https://github.com/Morantron/tmux-fingers) | Vimium-like copy and paste hints | 1354 |
...
| wfxr/[**tmux-fzf-url**](https://github.com/wfxr/tmux-fzf-url) | Quick URL opening with fzf | 655 |
...
| tmux-plugins/[**tmux-pain-control**](https://github.com/tmux-plugins/tmux-pain-control) | Standard pane key-bindings for tmux | 836 |
| jaclu/[**tmux-power-zoom**](https://github.com/jaclu/tmux-power-zoom) | Zoom pane to a separate window | 62 |
| fcsonline/[**tmux-thumbs**](https://github.com/fcsonline/tmux-thumbs) | Fast copy and paste with Rust-powered hints | 1040 |
...
| christoomey/[**vim-tmux-navigator**](https://github.com/christoomey/vim-tmux-navigator) | Seamless navigation between Vim and tmux | 6106 |

## Session

| Plugin | Description | Stars |
|--------|-------------|-------|
| joshmedeski/[**sesh**](https://github.com/joshmedeski/sesh) | Smart terminal session manager | 1792 |
| juancruzfl/[**tmux-canvas**](https://github.com/juancruzfl/tmux-canvas) | Layout management with state persistence | 6 |
| tmux-plugins/[**tmux-continuum**](https://github.com/tmux-plugins/tmux-continuum) | Continuous saving of tmux environment | 3840 |
...
| tmux-plugins/[**tmux-resurrect**](https://github.com/tmux-plugins/tmux-resurrect) | Persists tmux environment across system restarts | 12518 |
...
| omerxx/[**tmux-sessionx**](https://github.com/omerxx/tmux-sessionx) | Session manager with zoxide and fuzzy finding | 1207 |
...
| tmux-python/[**tmuxp**](https://github.com/tmux-python/tmuxp) | Session manager for tmux built on libtmux | 4441 |

## Statusbar

| Plugin | Description | Stars |
|--------|-------------|-------|
| arl/[**gitmux**](https://github.com/arl/gitmux) | Show Git status in the status bar | 761 |
...
| accessd/[**tmux-agent-indicator**](https://github.com/accessd/tmux-agent-indicator) | Visual feedback for AI agent states in pane borders and status bar | 22 |
| tmux-plugins/[**tmux-battery**](https://github.com/tmux-plugins/tmux-battery) | Battery percentage and icon indicator | 557 |
...
| tmux-plugins/[**tmux-cpu**](https://github.com/tmux-plugins/tmux-cpu) | CPU usage percentage display | 512 |
...
| fabioluciano/[**tmux-powerkit**](https://github.com/fabioluciano/tmux-powerkit) | Ultimate status bar framework with many widgets | 487 |
| erikw/[**tmux-powerline**](https://github.com/erikw/tmux-powerline) | Dynamic powerline-style status bar segments | 3728 |
...
| catppuccin/[**tmux**](https://github.com/catppuccin/tmux) | Soothing pastel theme for Tmux | 2861 |
...
| egel/[**tmux-gruvbox**](https://github.com/egel/tmux-gruvbox) | Light and dark gruvbox color scheme | 664 |
...
| Plugin | Description | Stars |
|--------|-------------|-------|
| laktak/[**extrakto**](https://github.com/laktak/extrakto) | Clipboard copy and fzf completions from output | 1078 |
...
| NHDaly/[**tmux-better-mouse-mode**](https://github.com/NHDaly/tmux-better-mouse-mode) | Better mouse scroll and click configuration | 966 |
| Alkindi42/[**tmux-bitwarden**](https://github.com/Alkindi42/tmux-bitwarden) | Access Bitwarden login items from tmux | 44 |
| lost-melody/[**tmux-command-palette**](https://github.com/lost-melody/tmux-command-palette) | Keybinding search palette with fzf | 32 |
...
| sainnhe/[**tmux-fzf**](https://github.com/sainnhe/tmux-fzf) | Manage tmux environment with fzf | 1351 |
...
| tmux-plugins/[**tmux-logging**](https://github.com/tmux-plugins/tmux-logging) | Logging and screen capturing utilities | 1208 |
| jaclu/[**tmux-menus**](https://github.com/jaclu/tmux-menus) | Popup menus for environment management | 470 |
...
| rickstaa/[**tmux-notify**](https://github.com/rickstaa/tmux-notify) | Notify when long-running processes finish | 236 |
...
| tmux-plugins/[**tmux-sensible**](https://github.com/tmux-plugins/tmux-sensible) | A set of tmux options that should be acceptable to everyone | 2124 |
| tmux-plugins/[**tmux-sidebar**](https://github.com/tmux-plugins/tmux-sidebar) | Directory tree sidebar for navigation | 616 |
| azorng/[**tmux-smooth-scroll**](https://github.com/azorng/tmux-smooth-scroll) | Smooth scrolling in copy mode | 57 |
...
| jabirali/[**tmux-tilish**](https://github.com/jabirali/tmux-tilish) | Tiling window manager features inspired by i3 | 484 |
...
| alexwforsythe/[**tmux-which-key**](https://github.com/alexwforsythe/tmux-which-key) | Customizable popup menu for keybinding discovery | 242 |
| gcla/[**tmux-wormhole**](https://github.com/gcla/tmux-wormhole) | Download files with magic wormhole | 119 |
| tmux-plugins/[**tmux-yank**](https://github.com/tmux-plugins/tmux-yank) | Tmux plugin for copying to system clipboard | 3037 |
| laktak/[**tome**](https://github.com/laktak/tome) | Interactive script playbooks for the terminal | 156 |
| kiyoon/[**treemux**](https://github.com/kiyoon/treemux) | Nvim-Tree file explorer sidebar | 192 |
